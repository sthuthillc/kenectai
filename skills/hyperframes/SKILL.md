...
| **Author seek-safe keyframes** — GSAP timelines, CSS keyframes, Anime.js, WAAPI, FLIP, paths, masks, SVG morph/draw, 3D depth, plus `kenectai keyframes` diagnostics  | `/hyperframes-keyframes` |
...
| **Install registry blocks / components** (`kenectai add`)                                                                                                             | `/hyperframes-registry`  |
