...
- **One accent hue, heavy weight** — embedded display faces (Archivo Black, League Gothic, Oswald) at 150px+; see `kenectai-creative/references/typography.md`.
...
- `/kenectai-animation` — timeline + easing vocabulary (`../../adapters/gsap-easing-and-stagger.md`)
- `/kenectai-creative` — `references/video-composition.md` (foreground rhythm chrome), `references/typography.md` (embedded display fonts)
- `/kenectai-core` — composition wiring, determinism (finite repeats)
