...
- **One accent hue, consistent blueprint** — see `kenectai-creative/references/data-in-motion.md`.
...
- `/kenectai-animation` — timeline + transform tweens
- `/kenectai-creative` — `references/data-in-motion.md` (stat layout + visual weight)
- `/kenectai-core` — composition wiring; the no-`width`/`height`-tween rule
