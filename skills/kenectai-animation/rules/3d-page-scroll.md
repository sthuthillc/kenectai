...
- `/kenectai-animation` — timeline + ease reference; `y:` tween basics
- `/kenectai-core` — composition wiring, `data-*` attributes
- `/kenectai-cli` — `kenectai lint` to verify the registry key + duration
