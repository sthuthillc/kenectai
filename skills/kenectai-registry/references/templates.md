    ...
    <script>
      (function () {
        ...
        GROUPS.forEach(function (g, gi) {
          ...
          if (window.__kenectai && window.__kenectai.fitTextFontSize) {
            var _fit = window.__kenectai.fitTextFontSize(g.text.toUpperCase(), {
