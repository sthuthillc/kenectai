---
name: kenectai-registry
description: Install and wire registry blocks and components into KENECT AI compositions. Use when running kenectai add, installing a block or component, wiring an installed item into index.html, or working with kenectai.json. Covers the add command, install locations, block sub-composition wiring, component snippet merging, registry discovery, and authoring a new block or component to contribute upstream (idea → scaffold → validate → PR).
---
