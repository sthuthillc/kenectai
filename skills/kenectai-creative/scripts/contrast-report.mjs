...
//
// Usage:
//   node skills/kenectai-creative/scripts/contrast-report.mjs <composition-dir> \
//     [--samples N] [--out <dir>] [--width W] [--height H] [--fps N]
//
// Env:
//   KENECT_SKILL_PKG_VERSION — pin the @kenectai/producer version used
...
import { kenectaiPackageSpec, importPackagesOrBootstrap } from "./package-loader.mjs";
...
const packages = await importPackagesOrBootstrap(["@kenectai/producer", "sharp"], {
  npmPackages: [kenectaiPackageSpec("@kenectai/producer"), "sharp@0.34.5"],
});
...
const OUT_DIR = resolve(args.out ?? ".kenectai/contrast");
