...
This POC should feel like a real VS Code tutorial capture, not a generic code window. The purpose is to prove that KENECT AI can render code-writing scenes with faithful product context and theme-aware polish.
