...
This page lists organizations using KENECT AI in production or actively evaluating it. If your team is shipping with KENECT AI — whether you're rendering hundreds of videos a day, building agent-driven composition tooling, or experimenting with HTML-as-video for the first time — we'd love to hear about it.

Adding your organization helps the community understand how KENECT AI is being used in the wild and makes it easier for new users to find peers solving similar problems.
...
- **How KENECT AI is used** — one sentence on the use case (e.g., "Personalized video at scale," "Agent-authored marketing assets," "Slides-to-video pipeline").
...
| Organization                             | Contact                                          | How KENECT AI is used                                                                                       |
| ---------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
...
| [TanStack](https://tanstack.com)         | [@AlemTuzlak](https://github.com/AlemTuzlak)     | Exploring KENECT AI for short-form code demo videos and documentation.                                      |
| [OptinMonster](https://optinmonster.com) | Angie Meeker                                     | Exploring KENECT AI for marketing and product video content.                                                |
