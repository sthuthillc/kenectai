 ...
 * which is why review finding 10 was that `kenect_render_not_found`
...
const ERROR_CODE_HINTS: Record<string, string> = {
  ...
  authentication_failed:
    "Run `kenectai auth status` to confirm your credential; `kenectai auth login` to re-auth.",
 ...
 *     (e.g. "Resume with: kenectai cloud get hfr_X" on poll
