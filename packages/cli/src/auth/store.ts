/**
 * Read/write the shared `~/.kenectai/credentials` file (JSON contents,
 * no `.json` extension).
 *
 * Current format:
 *   {
 ...
 *   }
 *
 * Legacy: a single-line plaintext API key (the format early CLIs may have
 ...
 *
 * Cross-CLI forward compatibility: this file is shared across KENECT AI tools.
 * Another CLI may write keys this
 ...
 * `user` block companion KENECT tools may write.
 */
...
/**
 * Legacy-plaintext heuristic. KENECT AI API keys can come in multiple formats
