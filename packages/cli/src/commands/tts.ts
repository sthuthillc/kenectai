...
export const examples: Example[] = [
  ["Generate speech from text", 'kenectai tts "Welcome to KENECT AI"'],
  ["Choose a voice", 'kenectai tts "Hello world" --voice am_adam'],
  ["Save to a specific file", 'kenectai tts "Intro" --voice bf_emma --output narration.wav'],
  ["Adjust speech speed", 'kenectai tts "Slow and clear" --speed 0.8'],
  [
    "Generate Spanish speech",
    'kenectai tts "La reunión empieza a las nueve" --voice ef_dora --output es.wav',
  ],
  [
    "Override phonemizer language",
    'kenectai tts "Ciao a tutti" --voice af_heart --lang it --output accented.wav',
  ],
  ["Read text from a file", "kenectai tts script.txt"],
  ["List available voices", "kenectai tts --list"],
];
