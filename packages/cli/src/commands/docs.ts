...
export const examples: Example[] = [
  ["List all available topics", "kenectai docs"],
  ["Read about data attributes", "kenectai docs data-attributes"],
  ["Read about rendering", "kenectai docs rendering"],
  ["Read about GSAP integration", "kenectai docs gsap"],
];
...
export default defineCommand({
  ...
  async run({ args }) {
    ...
    if (topic === undefined || topic === "") {
      ...
      console.log();
      console.log(c.dim(`Run ${c.accent("kenectai docs <topic>")} to view a topic.`));
      return;
    }
