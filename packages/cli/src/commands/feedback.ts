...
import { buildIssueUrl, KENECT_REPO_URL } from "../utils/feedbackIssue.js";
import { VERSION } from "../version.js";
import { c } from "../ui/colors.js";

export const examples: Example[] = [
  ["Submit render feedback", 'kenectai feedback --rating 4 --comment "fast but font missing"'],
  ["Quick rating only", "kenectai feedback --rating 5"],
  [
    "Also file a GitHub issue with a published repro",
    'kenectai feedback --rating 2 --comment "GSAP timeline froze" --file-issue',
  ],
];
