...
export const examples: Example[] = [
  ["Publish the current project with a public URL", "kenectai publish"],
  ["Publish a specific directory", "kenectai publish ./my-video"],
  ["Make the claimed project public to anyone", "kenectai publish --public"],
  ["Skip the consent prompt (scripts)", "kenectai publish --yes"],
];
...
export default defineCommand({
  ...
  async run({ args }) {
    ...
    if (args.yes !== true) {
      console.log();
      console.log(
        `  ${c.bold("kenectai publish uploads this project and creates a stable public URL.")}`,
      );
      console.log(
    ...
    clack.intro(c.bold("kenectai publish"));
    ...
    try {
      ...
      console.log();
      console.log(
        `  ${c.dim("Open the URL in KENECT AI to claim the project and continue editing.")}`,
      );
      console.log();
      return;
    } catch (err: unknown) {
