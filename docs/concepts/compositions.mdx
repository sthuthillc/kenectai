---
title: Compositions
description: "The fundamental building block of a KENECT AI video."
---
...
KENECT AI does not automatically bind `data-var-*` attributes into your composition DOM or CSS.
...
If you are building tooling on top of `@kenectai/core`, the same `data-composition-variables` array is readable via `extractCompositionMetadata()` for Studio editing UI and analysis pipelines.
