...
description: "Bring your own animation runtime to KENECT AI."
---

The Frame Adapter pattern is how KENECT AI supports multiple animation runtimes. The core question every adapter answers:

> What should the screen look like at frame N?

If a runtime can answer that, it can plug into KENECT AI.
...
These rules are non-negotiable for any adapter. They are the foundation of KENECT AI' [deterministic rendering](/concepts/determinism) guarantee.
...
Community adapters are welcome -- if it can seek by frame, it belongs in KENECT AI.
