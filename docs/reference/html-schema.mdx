...
description: "Complete reference for authoring KENECT AI HTML compositions."
---

This is the full schema reference for KENECT AI compositions. For a gentler introduction, see [Compositions](/concepts/compositions) and [Data Attributes](/concepts/data-attributes).

## Overview

KENECT AI uses HTML as the source of truth for describing a video:
...
<Check>
  ...
  - Run `npx @kenectai/cli lint` to catch structural issues automatically
</Check>
