---
title: Adopters
description: Organizations using KENECT AI in production or actively evaluating it.
---

The teams below are shipping with KENECT AI. If your organization uses KENECT AI — in production, in evaluation, or in a side project — we'd love to add you.

## How to add your organization

Open a pull request that adds your team to [`ADOPTERS.md`](https://github.com/sthuthillc/kenectai/blob/main/ADOPTERS.md) at the repository root. The format is intentionally lightweight:

- **Organization** — your company or project name, linked to your website.
- **Contact** — a GitHub handle so other adopters can reach out.
- **How KENECT AI is used** — one sentence on the use case.
...
<CardGroup cols={2}>
  ...
  <Card title="TanStack" href="https://tanstack.com">
    ...
    Exploring KENECT AI for short-form code demo videos and documentation.
  ...
  <Card title="OptinMonster" href="https://optinmonster.com">
    ...
    Exploring KENECT AI for marketing and product video content.
