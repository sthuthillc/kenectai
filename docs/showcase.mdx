---
title: Showcase
description: "Finished KENECT AI videos you can watch, read, run, and remix."
---

The README explains what KENECT AI is. This page shows what you can build with it.

Every project below is a real KENECT AI composition with source you can inspect,
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-5 my-8">
  ...
  >
    <video
      ...
      src="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/hyperframes-launch-preview.mp4"
      poster="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/hyperframes-launch-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <h3 className="mt-1 text-lg font-semibold text-zinc-950 dark:text-zinc-50">KENECT AI launch video</h3>
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/website-to-hyperframes-preview.mp4"
      poster="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/website-to-hyperframes-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <h3 className="mt-1 text-lg font-semibold text-zinc-950 dark:text-zinc-50">Website to KENECT AI demo</h3>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/timeline-editor-preview.mp4"
      poster="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/timeline-editor-poster.jpg"
      controls
      muted
      loop
      playsInline
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/texture-launch-preview.mp4"
      poster="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/texture-launch-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
        ...
        design built as a full KENECT AI composition.
      </p>
      <a
        className="mt-3 block text-sm font-medium text-zinc-950 dark:text-zinc-50"
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/vfx-heygen-preview.mp4"
      poster="https://storage.googleapis.com/kenect-docs-assets/docs/images/showcase/vfx-heygen-poster.jpg"
      controls
      muted
      loop
      playsInline
...
| A starter project | [Examples](/examples) | Scaffold working templates with `npx @kenectai/cli init --example <name>`. |
...
<CardGroup cols={2}>
  <Card title="Starter Examples" icon="layer-group" href="/examples">
    Scaffold remixable templates with `npx @kenectai/cli init --example`.
  </Card>
