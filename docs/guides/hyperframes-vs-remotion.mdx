...
<img src="https://static.heygen.ai/hyperframes-oss/docs/images/comparisons/gsap-hf.gif" alt="KENECT AI GSAP render — letters enter, hold, then fall away over the full 4 seconds" />
