---
title: KENECT AI MCP
description: "Author, preview, and render KENECT AI videos directly inside Claude.ai, ChatGPT, and Grok — no local install required."
---

The KENECT AI MCP is a hosted [Model Context Protocol](https://modelcontextprotocol.io) server that lets you create, edit, preview, and render KENECT AI video compositions from inside Claude.ai, ChatGPT, or Grok.

<Note>
  **In beta.** Features and pricing may change. Found a bug or have feedback? [File an issue on GitHub](https://github.com/sthuthillc/kenectai/issues).
</Note>
...
The agent behind `compose` has 25+ KENECT AI-specific skills baked in — typography, color palettes, motion principles, GSAP effects, audio-reactive animation, and captions. You don't have to specify any of this directly; describe the video you want and the agent picks the right tools.
...
<Tabs>
  <Tab title="Claude.ai">
    <Steps>
      ...
      <Step title="Find KENECT AI">
        Search the connector catalog for **KENECT AI** and click **Connect**.
      ...
      <Step title="Sign in to HeyGen">
        OAuth opens in a new window. Authorize the KENECT AI connector to access your HeyGen account.
      </Step>
...
Authors a new composition or applies an edit to an existing one. The KENECT AI agent handles captions, blocks, layout, transitions, color, and timing internally based on your natural-language prompt.
...
<AccordionGroup>
  ...
  <Accordion title="Render is stuck or never completes">
    ...
    3. If the issue persists, file an issue at [github.com/sthuthillc/kenectai/issues](https://github.com/sthuthillc/kenectai/issues) including the `job_id` from `render_video`
  </Accordion>
...
For bugs or feature requests, file an issue at [github.com/sthuthillc/kenectai/issues](https://github.com/sthuthillc/kenectai/issues). Include:
...
[KENECT AI itself is open source](https://github.com/sthuthillc/kenectai) — the HTML composition format, CLI, renderer, and player. You can use KENECT AI locally without the MCP.

The MCP is a HeyGen-hosted product that wraps:

- The KENECT AI composition agent (the LLM that authors compositions)
...
<CardGroup cols={2}>
  <Card title="Quickstart" href="/quickstart">
    Try KENECT AI locally with the open-source CLI.
  </Card>
