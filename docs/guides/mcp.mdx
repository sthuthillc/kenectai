...
[HyperFrames itself is open source](https://github.com/sthuthillc/kenectai) — the HTML composition format, CLI, renderer, and player. You can use HyperFrames locally without the MCP.
