---
title: "@kenectai/shader-transitions"
description: "WebGL shader transitions for KENECT AI scenes and compositions."
---

The shader transitions package adds GPU-accelerated scene-to-scene transitions to KENECT AI compositions. It captures scene samples, uploads them as WebGL textures, and drives fragment-shader compositing from a GSAP timeline.
...
**Use `@kenectai/shader-transitions` when you need to:**
