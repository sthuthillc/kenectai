...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://storage.googleapis.com/kenect-docs-assets/docs/images/catalog/blocks/code-diff.mp4" poster="https://storage.googleapis.com/kenect-docs-assets/docs/images/catalog/blocks/code-diff.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @kenectai/cli add code-diff
```
